...
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,"res1",ng,"gr1",info,"psol1","pjac1");
...
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,"res1",ng,"gr1",info);
...
info=list([],0,[],[],[],0,[],1,[],0,1,[],[],1);
atol=1.d-6;rtol=0;ng=2;
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res1,ng,"gr1",info,psol,pjac);
assert_checkalmostequal(nn(1),2.47,0.001);
y0=yy(2,2);y0d=yy(3,2);t0=nn(1);t=[3,4,5,6];
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res1,ng,"gr1",info,psol,pjac);
assert_checkalmostequal(nn(1),2.5,0.001);
...
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,"res2","jac2",ng,"gr2",info);
...
info=list([],0,[],[],[],0,[],1,[],0,1,[],[],1);
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res2,jac2,ng,"gr2",info,"psol1","pjac1");
...
funcprot(prot);
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res2,jac2,ng,"gr2",info,psol,pjac);
...
[yy,nn,hotd]=%_daskr([y0,y0d],t0,t,atol,rtol,"res2","jac2",ng,"gr2",info);
t01=nn(1);t=100:20:200;[pp,qq]=size(yy);y01=yy(3:4,qq);y0d1=yy(4:5,qq);
[yy,nn,hotd]=%_daskr([y01,y0d1],t01,t,atol,rtol,"res2","jac2",ng,"gr2",info,hotd);
...
// Hot restart
t01=nn(1);t=100:20:200;[pp,qq]=size(yy);y01=yy(3:4,qq);y0d1=yy(4:5,qq);
[yy,nn,hotd]=%_daskr([y01,y0d1],t01,t,atol,rtol,"res22","jac22",ng,"gr22",info,hotd);

rtol=[1.d-6;1.d-6];
atol=[1.d-6;1.d-4];
t0=0;y0=[2;0];y0d=[0;-2];t=[20:20:200];ng=1;
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,"res22","jac22",ng,"gr22",info);
// Hot restart
[yy,nn,hotd]=%_daskr([y0,y0d],t0,t,atol,rtol,"res22","jac22",ng,"gr22",info);
t01=nn(1);t=100:20:200;[pp,qq]=size(yy);y01=yy(3:4,qq);y0d1=yy(4:5,qq);
[yy,nn,hotd]=%_daskr([y01,y0d1],t01,t,atol,rtol,"res22","jac22",ng,"gr22",info,hotd);
