...
types::Function::ReturnValue sci_dassl(types::typed_list &in, int _iRetCount, types::typed_list &out)
{
    ...
    // get next inputs
    DifferentialEquationFunctions deFunctionsManager(L"%_dassl");
