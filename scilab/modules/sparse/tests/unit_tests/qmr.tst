...
// 1. Interface
// ============
assert_checkerror( "qmr()", "%s: Wrong number of input arguments: %d to %d expected.\n", 10000, "qmr", 2, 7);
assert_checkerror( "qmr(1)", "%s: Wrong number of input arguments: %d to %d expected.\n", 10000, "qmr", 2, 7);
assert_checkerror( "qmr([1 2;3 4])", "%s: Wrong number of input arguments: %d to %d expected.\n", 10000, "qmr", 2, 7);
...
function y = funcA_badproto(x)
    Amat = [10,1;1,10];
    y = Amat'*x;
endfunction

assert_checkfalse(execstr("qmr(funcA_badproto, b)"   ,"errcatch") == 0);
refMsg = msprintf(gettext("%s: Wrong prototype of input argument #%d: A function with %d input arguments expected.\n"), "qmr", 1, 2);
assert_checkerror("qmr(funcA_badproto, b)", refMsg);
...
function y = M1_badproto(x)
    M1 = eye(2,2);
    y = M1*x;
endfunction

assert_checkfalse(execstr("qmr(A, b, x0, M1_badproto)"   ,"errcatch") == 0);
refMsg = msprintf(gettext("%s: Wrong prototype of input argument #%d: A function with %d input arguments expected.\n"), "qmr", 4, 2);
assert_checkerror("qmr(A, b, x0, M1_badproto)", refMsg);
...
function y = M2_badproto(x)
    M2 = eye(2,2);
    y = M2*x;
endfunction

assert_checkfalse(execstr("qmr(A, b, x0, M1, M2_badproto)"   ,"errcatch") == 0);
refMsg = msprintf(gettext("%s: Wrong prototype of input argument #%d: A function with %d input arguments expected.\n"), "qmr", 5, 2);
assert_checkerror("qmr(A, b, x0, M1, M2_badproto)", refMsg);
